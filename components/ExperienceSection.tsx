      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold mb-4 text-white">
            ...
            <span className="text-[#4ec9b0]">CareerJourney</span>
          </h2>
        ...
        <div className="relative">
          ...
          <div className="space-y-12">
            {resumeData.experience.map((exp, index) => (
              <div key={exp.id} className="relative">
                ...
                {/* Journey step card */}
                <div
                  className={`ml-16 bg-[#252526] border border-[#3e3e42] rounded-lg p-8 hover:border-[#007acc] transition-all duration-700 hover:shadow-lg hover:shadow-[#007acc]/10 transform relative ${
                ...
                >
                  ...
                  <div className="absolute -left-4 top-8 w-0 h-0 border-t-8 border-b-8 border-r-8 border-transparent border-r-[#252526]"></div>
          ...
          {/* Journey end marker */}
          <div className="absolute left-6 bottom-0 w-4 h-4 bg-[#dcb67a] rounded-full border-4 border-[#1e1e1e] z-10 shadow-lg shadow-[#dcb67a]/50"></div>
        </div>
      </div>
    </section>
  )
